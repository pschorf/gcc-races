...
void
gomp_datarace_begin_ordered_section(uint64_t region_id) __attribute__ ((noinline));
void
gomp_datarace_end_ordered_section() __attribute__ ((noinline));

void
gomp_datarace_begin_ordered_section(uint64_t region_id)
{
  return;
}

void
gomp_datarace_end_ordered_section()
{
  return;
}
...
GOMP_ordered_start (void)
{
  ...
  gomp_datarace_begin_ordered_section(ws->ws_id);
}
//#endif
